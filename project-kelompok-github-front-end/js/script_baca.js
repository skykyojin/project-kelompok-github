document.addEventListener('DOMContentLoaded', function () {
  ...
  // Cek simpanan preferensi Mode Gelap dari localStorage
  if (localStorage.getItem('reader_dark_mode') === 'true') {
    isDarkMode = true;
    document.body.classList.add('dark-mode');
    if (darkModeBtn) {
      darkModeBtn.innerHTML = '<i class="fa-solid fa-sun"></i>';
      darkModeBtn.style.color = '#f1c40f';
    }
  }
